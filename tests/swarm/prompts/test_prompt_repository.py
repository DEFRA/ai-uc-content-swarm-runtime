...
from app.swarm.prompts import repository
from tests.swarm.prompts.fakes import FakeFileSystem


class TestFileSystemPromptRepositoryLoad:
    @pytest.mark.asyncio
    async def test_load_prompt_file_returns_file_contents(self) -> None:
        ...
        repo = repository.FileSystemPromptRepository(fs=fake_fs)
    ...
    @pytest.mark.asyncio
    async def test_load_prompt_with_multiline_content(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_load_prompt_preserves_whitespace(self) -> None:
...
class TestFileSystemPromptRepositoryCaching:
    @pytest.mark.asyncio
    async def test_caching_prevents_re_read(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cache_is_persistent_across_calls(self) -> None:
...
class TestFileSystemPromptRepositoryErrors:
    ...
    @pytest.mark.asyncio
    async def test_missing_prompt_error_message_includes_name(self) -> None:
...
class TestFileSystemPromptRepositoryMultiplePrompts:
    ...
    @pytest.mark.asyncio
    async def test_load_multiple_different_prompts(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cache_stores_different_prompts(self) -> None:
